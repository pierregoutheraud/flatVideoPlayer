...
FVP = (function() {
  ...
  FVP.prototype.isFullscreen = false;

  FVP.prototype.isFullscreen2 = false;
  ...
  function FVP(options) {
    ...
    this.fullscreenChange = __bind(this.fullscreenChange, this);
  ...
  FVP.prototype.initHTML = function() {
    ...
    this.videoPlayer.style.width = this.videoSize.width + 'px';
    this.videoPlayer.style.height = this.videoSize.height + 'px';
  ...
  FVP.prototype.initDuration = function() {
    ...
    return this.playerTime.parentNode.classList.add('visible');
  };
  ...
  FVP.prototype.togglefullscreen = function() {
    ...
    return this.videoPlayer.classList.toggle("fullscreen");
  };

  FVP.prototype.fullscreenChange = function(e) {
    if (this.isFullscreen2) {
      this.isFullscreen2 = false;
    } else {
      this.isFullscreen2 = true;
    }
    if (this.isFullscreen && !this.isFullscreen2) {
