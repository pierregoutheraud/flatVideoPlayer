...
class FVP
  ...
  # Si fullscreen est quitté par ESC, on toggle le fullscreen
  # @isFullscreen2 est changé à chaque fullscreenChange alors que @isFullscreen est changé a chaque toggleFullscreen
  fullscreenChange: (e) =>
    if @isFullscreen2 then @isFullscreen2 = false else @isFullscreen2 = true
